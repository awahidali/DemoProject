...
public class APIsCall {
    ...
    public static String baseURL = "https://miro.com/api";
    ...
    public static boolean createBoard(WebDriver driver) {
        boolean flag = true;
        ...
        try {
            Response response = given()
                    ...
                    .queryParam("accountId","3458764523629097685")
                    .log().all()
                    .when()
            ...
            boardId = id;
            ExtentTestManager.getTest().log(Status.PASS, "New blank board is created with id : "+boardId);
    ...
    public static void invite(String user) throws IOException {
       ...
       ExtentTestManager.getTest().log(Status.INFO,"Requested URL : "+baseURL+endPoint);
